...
namespace Read1CD
{
    ...
    public class v8Table
    {
        ...
        public v8Table(v8Base1CD _base, Int32 block_descr)
        {
            base_ = _base;
        ...
        public v8Table(v8Base1CD _base, String _descr, Int32 block_descr = 0)
        {
            base_ = _base;
        ...
        public v8Base1CD getbase() { return base_; }
